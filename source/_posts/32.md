---
title: TensorFlow：波士顿房价预测
categories: 机器学习
tags: 机器学习
mathjax: true
date: 2018-09-06 15:29:39
---
...
"""
7.2f: 占位符宽度为7（包括两位小数点和符号“.”，不足 7 位则在开头填空格，多于 7 位则全部保留即可），保留小数点后两位（四舍五入）
"""
...
MAE 即平均绝对误差，平均绝对误差（Mean Absolute Deviation），又叫平均绝对离差，是所有单个观测值与算术平均值的偏差的绝对值的平均。平均绝对误差可以避免误差相互抵消的问题，因而可以准确反映实际预测误差的大小。

## 网络结构与运行结果

![网络结构](/img/basic_regression_2.png)
![运行结果](/img/basic_regression_1.png)
